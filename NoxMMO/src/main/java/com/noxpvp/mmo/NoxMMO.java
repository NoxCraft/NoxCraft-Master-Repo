...
//		register(playerAnimationListener, PacketType.IN_ENTITY_ANIMATION);
	...
	public void permissions() {
		...
		addPermission(new NoxPermission(this, StringUtil.join(".", PERM_NODE, "ability"), "Base MMO Node", PermissionDefault.FALSE,
				...
				new NoxPermission(this, StringUtil.join(".", PERM_NODE, "ability", FireSpinAbility.PERM_NODE), "Allows usage of the Fire Spin Ability.", PermissionDefault.OP),
				...
				new NoxPermission(this, StringUtil.join(".", PERM_NODE, "ability", ThrowAbility.PERM_NODE), "Allows usage of the Grapple Throw Ability.", PermissionDefault.OP),
				...
				new NoxPermission(this, StringUtil.join(".", PERM_NODE, "ability", TornadoAbility.PERM_NODE), "Allows usage of the Tornado Ability.", PermissionDefault.OP),
