...
public class ForcePullEntityAbility extends BaseEntityAbility implements IPVPAbility {
	...
	public ForcePullEntityAbility setRange(double range) {this.range = range; return this; }

	public int getMaxTargets() { return maxTargets; }

	public ForcePullEntityAbility setMaxTargets(int maxTargets) { this.maxTargets = maxTargets; return this; }
