...
public class MinersHelmetEntityAbility extends BaseEntityAbility {
	 ...
	 */
	public MinersHelmetEntityAbility setDuration(int duration) {this.duration = duration; return this;}
	 ...
	 * @return MinersHelmetAbility This instance
	 */
	public MinersHelmetEntityAbility setSpeed(int speed) {this.speed = speed; return this;}
