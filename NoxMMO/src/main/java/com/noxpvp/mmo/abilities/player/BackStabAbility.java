...
public class BackStabAbility extends BasePlayerAbility{
	 ...
	 */
	public void setDamagePercent(double damagePercent) {DamagePercent = damagePercent;}
	...
	public boolean execute() {
		...
		if (!(pYaw <= (tYaw + accuracy)) && (pYaw >= (tYaw - accuracy)) && (Math.random() * 100) > getChancePercent())
			return false;
		
		t.damage((DamagePercent / 100) * getDamage(), p);
