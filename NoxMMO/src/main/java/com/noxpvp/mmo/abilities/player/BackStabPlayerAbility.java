 ...
 *
 */
public class BackStabPlayerAbility extends BasePlayerAbility implements IPassiveAbility<EntityDamageByEntityEvent>, IPVPAbility {
	 ...
	 */
	public BackStabPlayerAbility setAccuracy(double accuracy) {this.accuracy = accuracy; return this;}
	 ...
	 * @return BackStabAbility This instance, used for chaining
	 */
	public BackStabPlayerAbility setTarget(LivingEntity target) {this.target = target; return this;}
