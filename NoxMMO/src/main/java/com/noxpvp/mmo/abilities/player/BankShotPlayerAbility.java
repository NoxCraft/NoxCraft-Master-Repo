...
public class BankShotPlayerAbility extends BasePlayerAbility implements IPVPAbility {
	...
	public BankShotPlayerAbility setSingleShotMode(boolean single) { this.singleShot = single; return this; }
	public boolean isSingleShotMode() { return this.singleShot; }
	
	public BankShotPlayerAbility setFiringSeconds(double seconds) { return setFiringTicks(Math.round(seconds * 20)); }
	
	public BankShotPlayerAbility setFiringTicks(long l) { firingTicks = l; return this; }
	 ...
	 */
	public BankShotPlayerAbility setRange(int range) {this.range = range; return this;}
	 ...
	 * @return
	 */
	public BankShotPlayerAbility setHitPlayers(boolean hitPlayers) {this.hitPlayers = hitPlayers; return this;}
	 ...
	 * @return
	 */
	public BankShotPlayerAbility setHitCreatures(boolean hitCreatures) {this.hitCreatures = hitCreatures; return this;}
	 ...
	 * @return BankShotAbility this instance, used for chaining
	 */
	public BankShotPlayerAbility setHitSelf(boolean hitSelf) {this.hitSelf = hitSelf; return this;}
