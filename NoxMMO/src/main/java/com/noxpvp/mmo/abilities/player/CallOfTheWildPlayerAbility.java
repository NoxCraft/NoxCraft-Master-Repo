...
public class CallOfTheWildPlayerAbility extends BasePlayerAbility{
	 ...
	 */
	public CallOfTheWildPlayerAbility setRange(double range) {this.range = range; return this;}
	 ...
	 * @return CallOfTheWildAbility This instance, used for chaining
	 */
	public CallOfTheWildPlayerAbility setCancelIfNearby(boolean cancelIfNearby) {this.cancelIfNearby = cancelIfNearby; return this;}
	 ...
	 * @return CallOfTheWildAbility This instance, used for chaining
	 */
	public CallOfTheWildPlayerAbility setSpawnType(EntityType spawnType) {this.spawnType = spawnType; return this;}
