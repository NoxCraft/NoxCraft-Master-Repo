...
public class ThrowPlayerAbility extends BasePlayerAbility implements IPVPAbility {
	 ...
	 */
	public ThrowPlayerAbility setRange(int range) {this.range = range; return this;}
	 ...
	 * @return GrappleThrowAbility This instance, used for chaining
	 */
	public ThrowPlayerAbility setMaxTargets(int maxTargets) {this.maxTargets = maxTargets; return this;}
	 ...
	 * @return GrappleThrowAbility This instance, used for chaining
	 */
	public ThrowPlayerAbility setPushDelay(int pushDelay) {this.pushDelay = pushDelay; return this;}
