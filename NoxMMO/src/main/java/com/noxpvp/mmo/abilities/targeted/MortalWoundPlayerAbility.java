...
public class MortalWoundPlayerAbility extends BaseTargetedPlayerAbility implements IPVPAbility {
	 ...
	 */
	public MortalWoundPlayerAbility setDuration(int duration) {this.duration = duration; return this;}
	 ...
	 * @return MortalWoundAbility This instance
	 */
	public MortalWoundPlayerAbility setAmplifier(int amplifier) {this.amplifier = amplifier; return this;}
